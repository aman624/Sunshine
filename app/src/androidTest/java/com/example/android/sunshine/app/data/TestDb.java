...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        Cursor cursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, null, null, null,
                null, null, null);
        ...
        // query if you like)
        TestUtilities.validateCursor("Error: inavlid weather record", cursor, contentValues);
    ...
    public long insertLocation() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Location query failed", cursor, contentValues);
