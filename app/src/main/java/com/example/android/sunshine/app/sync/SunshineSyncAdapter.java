...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    private static final String API_KEY = "442ca7fabbe739453f7aeff9700c30ef";
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                // This ensures that navigating backward from the Activity leads out of the application to the Home screen.
                ...
                // Same ID allows you to update the notification later on.
